...
async function connectToWA() {
  ...
  console.log("Connecting ❤️madhumal❤️");
  ...
  robin.ev.on("connection.update", (update) => {
    ...
    if (connection === "close") {
      ...
      console.log("❤️madhumal❤️ installed successful ✅");
      console.log("❤️madhumal❤️ connected to whatsapp ✅");

      let up = `❤️madhumal❤️ connected successful ✅`;
      let up1 = `Hello madhumal, I made bot successful`;
      ...
      robin.sendMessage("94743426307@s.whatsapp.net", {
        image: {
          url: `https://raw.githubusercontent.com/Dark-Robin/Bot-Helper/refs/heads/main/autoimage/Bot%20robin%20cs.jpg`,
        },
        caption: up1,
...
app.get("/", (req, res) => {
  res.send("hey, ❤️madhumal❤️ started✅");
});
app.listen(port, () =>
